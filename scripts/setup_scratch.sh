...
PATCH_SCRIPT="${HOME_PROJECT}/SmolVLA-Testing/patch_nvenc.py"
...
echo "        bash ~/smolvla_project/SmolVLA-Testing/restart_conversion.sh"
echo ""
echo "  2. Then launch training:"
echo "        bash ~/smolvla_project/SmolVLA-Testing/run_training.sh <dataset_name>"
echo ""
